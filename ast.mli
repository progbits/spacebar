...
type declaration_specifiers =
    StorageClass of { storage_class : storage_class;
      declaration_specifiers : declaration_specifiers option;
    }
  | TypeSpecifier of { type_specifier : type_specifier;
      declaration_specifiers : declaration_specifiers option;
    }
  | TypeQualifier of { type_qualifier : type_qualifier;
      declaration_specifiers : declaration_specifiers option;
    }
  | FunctionSpecifier of { function_specifier : function_specifier;
      declaration_specifiers : declaration_specifiers option;
    }
  | AlignmentSpecifier of { alignment_specifier : alignment_specifier;
      declaration_specifiers : declaration_specifiers option;
    }
type pointer = {
  type_qualifier_list : type_qualifier list option;
...
and direct_declarator =
  ...
  | FunctionDeclarator of { direct_declarator : direct_declarator;
...
and postfix_expression =
  ...
  | ArrayAccess of { postfix_expression : postfix_expression;
      expression : expression;
    }
  | FunctionCall of { postfix_expression : postfix_expression;
      expression : expression;
    }
  | MemberAccess of { postfix_expression : postfix_expression;
      identifier : string;
    }
  | PointerMemberAccess of { postfix_expression : postfix_expression;
      identifier : string;
    }
...
and unary_expression =
  ...
  | UnaryOperator of { operator : unary_operator;
...
and shift_expression =
  ...
  | LeftShiftExpression of { shift_expression : shift_expression;
      additive_expression : additive_expression;
    }
  | RightShiftExpression of { shift_expression : shift_expression;
      additive_expression : additive_expression;
    }
and relational_expression =
    ShiftExpression of shift_expression
  | LessThanExpression of { relational_expression : relational_expression;
      shift_expression : shift_expression;
    }
  | GreaterThanExpression of { relational_expression : relational_expression;
      shift_expression : shift_expression;
    }
...
and equality_expression =
  ...
  | EqualToExpression of { equality_expression : equality_expression;
      relational_expression : relational_expression;
    }
  | NotEqualToExpression of { equality_expression : equality_expression;
      relational_expression : relational_expression;
    }
and and_expression =
    EqualityExpression of equality_expression
  | BitwiseAndExpression of { and_expression : and_expression;
...
type init_declarator = {
  declarator : declarator;
  _initializer : assignment_expression option;
}
type declaration = {
  declaration_specifiers : declaration_specifiers;
...
and selection_statement =
  ...
  | IfElse of { expression : expression; body : statement;
      else_body : statement;
    }
...
and iteration_statement =
  ...
  | For of { init : expression option; condition : expression option;
      iteration : expression option; body : statement;
    }
